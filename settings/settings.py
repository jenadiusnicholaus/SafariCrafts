"""
Django settings for SafariCrafts project.
"""
...
SECRET_KEY = config('SECRET_KEY', default="django-insecure-o^mgh3d_za&7214g)9pru&j_sm(%h$)hvx8&jrz8dtc89-d09g")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=True, cast=bool)

ALLOWED_HOSTS = config('ALLOWED_HOSTS', default="127.0.0.1,localhost,192.168.1.181,*").split(',')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'SafariCrafts API',
    'DESCRIPTION': 'API for Tanzanian African Art Ecommerce Platform',
    'VERSION': '1.0.0',
